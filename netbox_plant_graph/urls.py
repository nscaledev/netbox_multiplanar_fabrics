...
urlpatterns = [
    ...
    path('stamp-runs/<int:pk>/retry-v25/', views.StampRunRetryV25View.as_view(), name='stamprun_retry_v25'),
    path('stamp-runs/<int:pk>/rollback-v25/', views.StampRunRollbackV25View.as_view(), name='stamprun_rollback_v25'),
    ...
    path('imports/reports/<int:pk>/export.json', views.ImportReportExportView.as_view(), name='import_report_export'),
    path('imports/reports/<int:pk>/replay/', views.ImportReportReplayView.as_view(), name='import_report_replay'),
    path('imports/reports/<int:pk>/apply/', views.ImportReportApplyView.as_view(), name='import_report_apply'),
    ...
    path(
        'architecture-workspaces/<int:pk>/sources/add/',
        views.ArchitectureWorkspaceSourceAddView.as_view(),
        name='architecture_workspace_source_add',
    ),
    path(
        'architecture-source-artifacts/<int:pk>/normalize/',
        views.ArchitectureSourceArtifactNormalizeView.as_view(),
        name='architecture_source_artifact_normalize',
    ),
    path(
        'architecture-workspaces/<int:pk>/validate/',
        views.ArchitectureWorkspaceValidateView.as_view(),
        name='architecture_workspace_validate',
    ),
    path(
        'architecture-workspaces/<int:pk>/plans/generate/',
        views.ArchitectureWorkspacePlanGenerateView.as_view(),
        name='architecture_workspace_plan_generate',
    ),
    path(
        'architecture-publish-plans/<int:pk>/approve/',
        views.ArchitecturePublishPlanApproveView.as_view(),
        name='architecture_publish_plan_approve',
    ),
    path(
        'architecture-publish-plans/<int:pk>/publish/',
        views.ArchitecturePublishPlanPublishView.as_view(),
        name='architecture_publish_plan_publish',
    ),
    path(
        'architecture-workspaces/<int:pk>/publish/',
        views.ArchitectureWorkspacePublishView.as_view(),
        name='architecture_workspace_publish',
    ),
    path(
        'architecture-workspaces/<int:pk>/handoff.json',
        views.ArchitectureWorkspaceHandoffView.as_view(),
        name='architecture_workspace_handoff',
    ),
    path(
        'onboarding-workspaces/<int:pk>/sources/add/',
        views.OnboardingWorkspaceSourceAddView.as_view(),
        name='onboarding_workspace_source_add',
    ),
    path(
        'onboarding-source-artifacts/<int:pk>/normalize/',
        views.OnboardingSourceArtifactNormalizeView.as_view(),
        name='onboarding_source_artifact_normalize',
    ),
    path(
        'onboarding-workspaces/<int:pk>/prerequisites/discover/',
        views.OnboardingWorkspacePrerequisitesDiscoverView.as_view(),
        name='onboarding_workspace_prerequisites_discover',
    ),
    path(
        'onboarding-prerequisites/<int:pk>/resolve/',
        views.OnboardingPrerequisiteResolveView.as_view(),
        name='onboarding_prerequisite_resolve',
    ),
    path(
        'onboarding-workspaces/<int:pk>/plans/generate/',
        views.OnboardingWorkspacePlanGenerateView.as_view(),
        name='onboarding_workspace_plan_generate',
    ),
    path(
        'onboarding-plans/<int:pk>/approve/',
        views.OnboardingPlanApproveView.as_view(),
        name='onboarding_plan_approve',
    ),
    path(
        'onboarding-plans/<int:pk>/apply/',
        views.OnboardingPlanApplyView.as_view(),
        name='onboarding_plan_apply',
    ),
    path(
        'onboarding-workspaces/<int:pk>/readiness/',
        views.OnboardingWorkspaceReadinessView.as_view(),
        name='onboarding_workspace_readiness',
    ),
    path(
        'onboarding-workspaces/<int:pk>/publish/',
        views.OnboardingWorkspacePublishView.as_view(),
        name='onboarding_workspace_publish',
    ),
    path(
        'onboarding-workspaces/<int:pk>/handoff.json',
        views.OnboardingWorkspaceHandoffView.as_view(),
        name='onboarding_workspace_handoff',
    ),
