...
class V2ExternalContractSmokeTestCase(SimpleTestCase):
    ...
    def test_documented_registry_resources_match_local_api_registry(self):
        ...
        documented_resources = {
            ...
            'transceiver-profile-module-types',
            'transceiver-connector-profiles',
            'transceiver-lane-profiles',
            ...
            'onboarding-source-artifacts',
            'onboarding-design-items',
            'onboarding-prerequisites',
            'onboarding-plans',
            'onboarding-execution-stages',
            'onboarding-object-links',
        }
