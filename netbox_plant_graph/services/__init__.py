...
_EXPORTS = {
    ...
    'stamp_graph_assembly': ('netbox_plant_graph.services.assembly_stamp', 'stamp_graph_assembly'),
    'resolve_attachment_unit': ('netbox_plant_graph.services.graph_external_edges', 'resolve_attachment_unit'),
    'stamp_graph_external_edge': ('netbox_plant_graph.services.graph_external_edges', 'stamp_graph_external_edge'),
    'stamp_graph_external_path': ('netbox_plant_graph.services.graph_external_edges', 'stamp_graph_external_path'),
    'stamp_assembly_transfer_policy': (
        'netbox_plant_graph.services.assembly_topology',
        'stamp_assembly_transfer_policy',
    ),
