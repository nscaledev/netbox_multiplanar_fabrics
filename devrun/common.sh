...
# This branch defaults local bootstrap/test flows to the 4.2.3 baseline.
# Override NETBOX_RELEASE to target a different supported patch release, e.g.
#   NETBOX_RELEASE=4.5.7 ./dev.sh start
...
STATE_DIR="${STATE_DIR:-$HOME/.config/netbox-plant-graph-dev}"
...
PLUGIN_NAME="netbox_plant_graph"
COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-netbox_plant_graph_devrun}"
