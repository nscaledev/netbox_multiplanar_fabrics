...
ROLE_SLUGS = {
    ...
    'madison-t1-ew-plane-1-2': 'MAD-1 T1 E-W Plane 1-2',
    'madison-t1-ew-plane-3-4': 'MAD-1 T1 E-W Plane 3-4',
    'madison-t1-t2-ns': 'MAD-1 T1/T2 N-S',
    'madison-be-spine-plane-1': 'MAD-1 BE Spine Plane 1',
    'madison-be-spine-plane-2': 'MAD-1 BE Spine Plane 2',
    'madison-be-spine-plane-3': 'MAD-1 BE Spine Plane 3',
    'madison-be-spine-plane-4': 'MAD-1 BE Spine Plane 4',
    'madison-fe-core-edge': 'MAD-1 FE Core + Edge',
    'madison-control': 'MAD-1 Control',
    'madison-t1-t2-storage': 'MAD-1 T1/T2 Storage',
